...
replace github.com/x-ethr/server => ../..

require (
	github.com/x-ethr/server v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/x-ethr/color v0.1.1 // indirect
	github.com/x-ethr/text v0.1.17 // indirect
